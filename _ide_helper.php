...
')
     ...
     */ 
        ...
        {
                        /** @var \GetCodeDev\TestLevenshtein\TestLevenshtein $instance */
                        return $instance->checkDuplicate();
        }
                    /**
         * 
         *
         ...
         *
         * @param string $model
         * @return \GetCodeDev\TestLevenshtein\TestLevenshtein 
         * @static 
         */ 
...
namespace  { 
            ...
            class TestLevenshtein extends \GetCodeDev\TestLevenshtein\Facades\TestLevenshtein {}
